...
'''
env_name = 'HandManipulate-v10'
if env_name in registry.env_specs:
    del registry.env_specs[env_name]

register(
    id='HandManipulate-v10',
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRot0ver2',
    max_episode_steps=1000,

    reward_threshold=1000.0,
)
env_name = 'HandManipulate-v11'
if env_name in registry.env_specs:
    del registry.env_specs[env_name]

register(
    id='HandManipulate-v11',
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRot1ver2',
    max_episode_steps=1000,

    reward_threshold=1000.0,
)
env_name = 'HandManipulate-v12'
if env_name in registry.env_specs:
    del registry.env_specs[env_name]

register(
    id='HandManipulate-v12',
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRot2ver2',
    max_episode_steps=1000,
...
env_name = 'HandManipulate-v3'
if env_name in registry.env_specs:
    del registry.env_specs[env_name]

register(
    id='HandManipulate-v3',
    entry_point='gym.envs.mujoco.HandManipulate:HandEnv',
    max_episode_steps=1000,
...
register(
    ...
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRot0',
    max_episode_steps=1000,
...
register(
    ...
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRot1',
    max_episode_steps=1000,

    reward_threshold=1000.0,
)
env_name = 'HandManipulate-v2'
if env_name in registry.env_specs:
    del registry.env_specs[env_name]
register(
    id='HandManipulate-v2',
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRot2',
    max_episode_steps=1000,
...
register(
    id='HandManipulate-v2',
    entry_point='gym.envs.mujoco.HandManipulate:HandEnvRotSensory',
    max_episode_steps=1000,
